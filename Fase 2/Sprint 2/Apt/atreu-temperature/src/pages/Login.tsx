...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-card text-on grid place-items-center px-4 focus-brand">
      <form onSubmit={onSubmit} className="bg-white text-slate-900 rounded-xl shadow p-6 w-full max-w-sm">
        ...
        <div className="space-y-3">
          ...
          <button className="w-full py-2 bg-card text-white rounded hover:bg-card focus-brand">Entrar</button>
        </div>
      </form>
    </div>
  );
